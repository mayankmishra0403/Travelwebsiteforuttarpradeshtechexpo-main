...
export const citiesData: CityData[] = [
  ...
  // Newly added Purvanchal cities with local image mappings
  {
    ...
    placesToVisit: withFallbackByIndex([
      ...
      { name: 'Wyndham Falls', description: 'Lush forest waterfall trek', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Sita Kund', description: 'Sacred mythological pond', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Ancient Temple Complex', description: 'Cluster of shrines with carvings', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    ]),
    historicalPlaces: [],
    hiddenGems: [],
    famousDishes: withFallbackByIndex([
      { name: 'Baati Chokha', description: 'Roasted wheat balls with smoky chokha', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Kachori Jalebi', description: 'Sweet-spicy breakfast combo', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Churmura', description: 'Spiced puffed rice snack', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Malpua', description: 'Traditional sweet pancake dessert', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    ]),
    stayingPlaces: [],
  },
  {
    ...
    placesToVisit: withFallbackByIndex([
      ...
      { name: 'Mehnagar Fort', description: 'Ancient fort ruins with scenic views', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Durvasa Rishi Ashram', description: 'Mythological hermitage site', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Dattatreya Ashram', description: 'Spiritual retreat near river', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Tamsa River', description: 'Peaceful riverside landscapes', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    ]),
    hiddenGems: withFallbackByIndex([
      { name: 'Nizamabad Black Clay Pottery', description: 'Unique craft tradition', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Mubarakpur Saree Market', description: 'Traditional weaving and trade', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    ]),
    historicalPlaces: [],
    famousDishes: withFallbackByIndex([
      { name: 'Launglata', description: 'Flaky pastry stuffed with khoya', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Amla Laddu', description: 'Vitamin-rich sweet spheres', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Chawal ke Farre', description: 'Steamed rice rolls, lightly spiced', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Chole Samosa', description: 'Crispy samosa topped with spicy chole', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Arbi Patta Rolls', description: 'Colocasia leaf savory spirals', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Chatpati Chaat', description: 'Tangy street food mix', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Kalika Mutton', description: 'Richly spiced local mutton curry', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Chicken Biryani', description: 'Aromatic layered rice and chicken', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    ]),
    stayingPlaces: [],
  },
  {
    ...
    placesToVisit: withFallbackByIndex([
      ...
      { name: 'Surha Tal', description: 'Seasonal lake and bird habitat', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Bhrigu Ashram', description: 'Ancient sage hermitage', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Sitab Diara', description: 'Historic village area', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Janglee Baba Mandir', description: 'Temple in rustic setting', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    ]),
    historicalPlaces: [],
    hiddenGems: [],
    famousDishes: withFallbackByIndex([
      { name: 'Launglata', description: 'Khoya-filled festive pastry', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Litti Chokha', description: 'Roasted wheat and smoky mash', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
      { name: 'Litti Chhola', description: 'Variation with spicy chhola', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
